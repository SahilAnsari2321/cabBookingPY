...
class travel:
    ...
    #==========================================Define Functiom==================================================
        ...
        def Kilo():
            if var2.get() == 0:
                ...
                if varl1.get() == "Phagwara":
                    switch ={"Ludhiana": 10,"Jalandhar": 8,"Law Gate":6,"Phagwara": 0}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Ludhiana":
                    switch ={"Ludhiana": 0,"Jalandhar": 2,"Law Gate":5,"Phagwara": 10}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Jalandhar":
                    switch ={"Ludhiana": 2,"Jalandhar": 0,"Law Gate":3,"Phagwara": 8}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Law Gate":
                    switch ={"Ludhiana": 5,"Jalandhar": 3,"Law Gate":0,"Phagwara": 6}
                    Km.set(switch[varl2.get()])        
   ...
   #================================================mainframe========================================================================
    ...
    #===============================================Cab Information==============================================================
        ...
        self.cboPickup['value']=('','Phagwara','Law Gate','Jalandhar','Ludhiana')
        self.cboPickup.current(0)
        ...
        self.cboDrop['value']=('','Ludhiana','Jalandhar','Phagwara','Law Gate')
        self.cboDrop.current(0)
